...
class PreviewFragment internal constructor() : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        inflater.inflate(R.layout.photo_display_fragment, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Glide.with(photoDisplay).load(photo).fitCenter().into(photoDisplay)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        (activity as MainActivity).container.systemUiVisibility = FLAGS_NORMAL_SCREEN
    }
